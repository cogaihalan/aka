...
export function OrderSummary({
  ...
  const shipping = customShippingCost !== undefined ? customShippingCost : getShipping();
            ...
            <>
              {appliedDiscounts.map((discount) => (
                ...
                >
                  ...
                  <span>-{discount.discountAmount.toLocaleString()} VND</span>
                </div>
              ))}
              <div className="flex justify-between text-sm text-green-600 font-medium">
                <span>Total Discount</span>
                <span>-{discountTotal.toLocaleString()} VND</span>
              </div>
            </>
          )}
        </div>
