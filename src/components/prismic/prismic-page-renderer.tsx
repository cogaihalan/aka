...
export function PrismicPageRenderer({ content, type }: PrismicPageRendererProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      {type === 'blog_post' && data.featured_image && (
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Blog Post Tags */}
        {type === 'blog_post' && data.tags && data.tags.length > 0 && (
