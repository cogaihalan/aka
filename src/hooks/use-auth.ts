...
export function useAuth(): AuthContextType {
  ...
  const authContext: AuthContextType = useMemo(() => ({
    ...
    hasPermission: (permission: UserPermission) => hasPermission(appUser, permission),
    hasRole: (role: UserRole) => hasRole(appUser, role),
    hasAnyRole: (roles: UserRole[]) => hasAnyRole(appUser, roles),
    hasAnyPermission: (permissions: UserPermission[]) => hasAnyPermission(appUser, permissions),
