...
export const MOCK_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    seo: {
      title: "Home & Garden",
      description: "Shop home and garden essentials",
    },
    isActive: true,
    includeInMenu: true,
    createdAt: "2024-01-01T00:00:00Z",
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Shop sports and outdoor gear",
    },
    isActive: true,
    includeInMenu: true,
    createdAt: "2024-01-01T00:00:00Z",
  ...
  },
  {
    ...
    seo: {
      title: "Beauty & Health",
      description: "Shop beauty and health products",
    },
    isActive: true,
    includeInMenu: true,
    createdAt: "2024-01-01T00:00:00Z",
...
export const MOCK_PRODUCTS: MockProduct[] = [
  ...
  createMockProduct(
    5,
    "iPad Air 5th Gen",
    "Powerful tablet with M1 chip and Liquid Retina display",
    599.99,
    0,
    0,
    {
  ...
  createMockProduct(
    ...
    "Premium running shoes with responsive Boost technology",
    180.99,
    1,
    4,
    {
  ...
  createMockProduct(
    ...
    "Moisture-wicking athletic t-shirt for active lifestyle",
    29.99,
    1,
    3,
    {
  ...
  createMockProduct(
    ...
    "Classic hoodie with three stripes design",
    79.99,
    1,
    4,
    {
  ...
  createMockProduct(
    ...
    "Advanced cordless vacuum with laser dust detection",
    749.99,
    2,
    5,
    {
  ...
  createMockProduct(
    ...
    "Professional stand mixer for baking enthusiasts",
    399.99,
    2,
    6,
    {
  ...
  createMockProduct(
    ...
    "Insulated stainless steel tumbler keeps drinks hot or cold",
    35.99,
    3,
    8,
    {
  ...
  createMockProduct(
    ...
    "Sustainable fleece jacket made from recycled materials",
    99.99,
    3,
    9,
    {
  ...
  createMockProduct(
    ...
    "Gentle foaming cleanser for normal to oily skin",
    15.99,
    5,
    13,
    {
  ...
  createMockProduct(
    ...
    "4K QLED Smart TV with Quantum Dot technology",
    899.99,
    0,
    1,
    {
  ...
  createMockProduct(
    ...
    "Smart speaker with Alexa and improved audio",
    49.99,
    0,
    14,
    {
